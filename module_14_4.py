...
api = '7978207773:AAEGSHVuSmxvEgoVIp1gVqPdrQMlY9vjmzo'
bot = Bot(token=api)
...
async def get_buying_list(message):
    for index, product in enumerate(get_all_products()):
        await message.answer(f'Название: Product{product[1]} |'
                             f' Описание: описание {product[2]} | Цена: {product[3] * 100}')
        with open(f'images/img{index+1}.png', 'rb') as photo:
